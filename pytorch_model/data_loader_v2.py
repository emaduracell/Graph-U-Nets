...
def load_all_trajectories(tfrecord_path, meta_path, max_trajs):
    ...
    # Load meta.json for decoding and pass description to tfrecord_loader
    with open(meta_path, "r") as f:
        meta = json.load(f)
    description = _build_tfrecord_description(meta)
    loader = tfrecord_loader(tfrecord_path, index_path=None, description=description)
    list_of_trajs = []
    idx = 0  # debug idx
    sum_elements = 0
    element_num = 0
